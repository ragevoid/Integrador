 ...
 */
public class QuadraSelectorCronometro extends javax.swing.JFrame {
     ...
     */
    public QuadraSelectorCronometro() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        cronometro.labelNomeQuadra.setText(selectedQuadra);
        
        cronometro.setTitle("Cronômetro - "+SelectedQuadraName);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuadraSelectorCronometro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
